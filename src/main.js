...
//Добавить в выводе изображение
    ...
    const renderPage = list => {
        const productsList = list.map(item => renderProduct(item.title, item.price, item.description, item.img));
        console.log(productsList);
        //В вашем коде на уроке запятые на странице появлялись так как вы передавали в свойство innerHTML массив из верстки по каждому продукту. Я применила метод join чтобы из массива получить строку и уже строку вставила в
        // свойство innerHTML
